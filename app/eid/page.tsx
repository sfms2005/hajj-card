...
export default function EidPage() {
  ...
  return (
    <StationPageShell title="بطاقات العيد" bgClassName="bg-[#fff7ed]">
      ...
      <input
        id="eid-name"
        className="w-full max-w-[300px] rounded-2xl border border-[#fed7aa] bg-white px-4 py-3.5 text-right text-base text-[#1e293b] shadow-[0_2px_20px_-8px_rgba(180,83,9,0.12)] outline-none ring-[#c9a227]/20 placeholder:text-[#94a3b8] focus:border-[#c9a227]/50 focus:ring-2"
        value={name}
